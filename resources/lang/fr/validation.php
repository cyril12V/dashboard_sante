...
return [
    ...
    | la classe de validation. Certaines de ces règles ont plusieurs versions, telles que les règles
    | de taille. N'hésitez pas à ajuster chacun de ces messages ici.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez spécifier ici des messages de validation personnalisés pour des attributs en utilisant
    | la convention "attribute.rule" pour nommer les lignes. Cela permet de spécifier un
    | message personnalisé pour une règle d'attribut donnée.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour échanger notre espace réservé par quelque chose de plus
    | convivial pour le lecteur comme "Adresse E-Mail" au lieu de "email". Cela nous aide
