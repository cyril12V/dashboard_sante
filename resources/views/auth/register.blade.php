                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="name" placeholder="Nom Complet" required>
                                    </div>
                                    <div class="form-group">
...
<style>
    ...
    /* Style pour les titres - reste sur une seule ligne */
    .carousel-caption h5 {
        font-size: 19px;
    ...
    /* Style pour les descriptions - permet de passer à la ligne */
    .carousel-caption p {
        color: white; /* Texte en blanc pour le contraste */
        font-weight: 600; /* Mettre en gras */
        white-space: normal; /* Permet à la description de se répartir sur plusieurs lignes */
